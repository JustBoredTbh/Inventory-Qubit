...
namespace Inventory_Qubit.Views
{
    ...
    /// </summary>
    public sealed partial class BranchActivitiesPage : Page
    {
        public BranchActivitiesPage()
        {
            this.InitializeComponent();
            BranchActitiesDatePicker.SelectedDate = DateTime.Today;
            this.BranchActitiesDatePicker.LayoutUpdated += DatePickerControl_LayoutUpdated;
        }
        ...
        private void DatePickerControl_LayoutUpdated(object sender, object e)
        {
            ...
            if (VisualTreeHelper
                .GetOpenPopupsForXamlRoot(this.BranchActitiesDatePicker.XamlRoot)
